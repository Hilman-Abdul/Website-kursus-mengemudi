    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <select name="gender_user" class="form-control @error('gender_user') is-invalid @enderror" required>
                ...
                <option value="L" {{ old('gender_user') == 'L' ? 'selected' : '' }}>Laki-laki (L)</option>
                <option value="P" {{ old('gender_user') == 'P' ? 'selected' : '' }}>Perempuan (P)</option>
            </select>
        ...
        <div class="col-md-6 mb-3">
            ...
            <select name="jenis_paket" class="form-control @error('jenis_paket') is-invalid @enderror" required>
                ...
                <option value="manual" {{ old('jenis_paket') == 'manual' ? 'selected' : '' }}>Manual</option>
                <option value="matic" {{ old('jenis_paket') == 'matic' ? 'selected' : '' }}>Matic</option>
            </select>
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="date" name="tanggal1" class="form-control @error('tanggal1') is-invalid @enderror" required value="{{ old('tanggal1') }}">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="time" name="jam_mulai1" class="form-control @error('jam_mulai1') is-invalid @enderror" required value="{{ old('jam_mulai1') }}">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="time" name="jam_selesai1" class="form-control @error('jam_selesai1') is-invalid @enderror" required value="{{ old('jam_selesai1') }}">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="date" name="tanggal2" class="form-control @error('tanggal2') is-invalid @enderror" value="{{ old('tanggal2') }}">
            @error('tanggal2') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
        {{-- jam_mulai2 (OPSIONAL) --}}
        <div class="col-md-4 mb-3">
            <label>Jam Mulai P2</label>
            <input type="time" name="jam_mulai2" class="form-control @error('jam_mulai2') is-invalid @enderror" value="{{ old('jam_mulai2') }}">
            @error('jam_mulai2') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
        {{-- jam_selesai2 (OPSIONAL) --}}
        <div class="col-md-4 mb-3">
            <label>Jam Selesai P2</label>
            <input type="time" name="jam_selesai2" class="form-control @error('jam_selesai2') is-invalid @enderror" value="{{ old('jam_selesai2') }}">
