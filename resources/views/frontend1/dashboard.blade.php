  ...
  <div class="paket-container">
    ...
    <div class="paket-wrapper text-center">
      ...
      <div class="paket-card p-4">
        ...
        @guest
          {{-- Belum login --}}
          <a href="{{ route('login.page') }}" class="btn paket-btn w-100 mb-3">3 x 60 Menit Rp 250.000</a>
          <a href="{{ route('login.page') }}" class="btn paket-btn w-100 mb-3">6 x 60 Menit Rp 500.000</a>

            <form action="{{ route('pilih.paket') }}" method="POST">
              @csrf
              <input type="hidden" name="nama_paket" value="Kelas Memperlancar Manual">
              ...
              <button class="btn paket-btn w-100 mb-3">6 x 60 Menit Rp 500.000</button>
            </form>
      ...
      <!-- KELAS DASAR MANUAL -->
            ...
            <form action="{{ route('pilih.paket') }}" method="POST">
              @csrf
              <input type="hidden" name="nama_paket" value="Kelas Dasar Manual">
    ...
    <div class="paket-wrapper text-center">
      ...
      <div class="paket-card p-4">
        ...
        @guest
          <a href="{{ route('login.page') }}" class="btn paket-btn w-100 mb-3">3 x 60 Menit Rp 300.000</a>
          <a href="{{ route('login.page') }}" class="btn paket-btn w-100 mb-3">6 x 60 Menit Rp 600.000</a>

        @else
          @if(Auth::user()->nik == null)

            <a href="{{ route('data.lengkapi') }}" class="btn paket-btn w-100 mb-3">3 x 60 Menit Rp 300.000</a>
            <a href="{{ route('data.lengkapi') }}" class="btn paket-btn w-100 mb-3">6 x 60 Menit Rp 600.000</a>

          @else

            <form action="{{ route('pilih.paket') }}" method="POST">
              @csrf
              <input type="hidden" name="nama_paket" value="Kelas Memperlancar Matic">
              <input type="hidden" name="waktu" value="3 x 60 Menit">
              <input type="hidden" name="harga" value="300000">
              <input type="hidden" name="jenis_paket" value="matic">
              <button class="btn paket-btn w-100 mb-3">3 x 60 Menit Rp 300.000</button>
            </form>
            ...
            <form action="{{ route('pilih.paket') }}" method="POST">
              ...
              <input type="hidden" name="nama_paket" value="Kelas Memperlancar Matic">
              <input type="hidden" name="waktu" value="6 x 60 Menit">
              <input type="hidden" name="harga" value="600000">
              <input type="hidden" name="jenis_paket" value="matic">
              <button class="btn paket-btn w-100 mb-3">6 x 60 Menit Rp 600.000</button>
            </form>
      ...
      <div class="paket-card p-4 mt-4">
        ...
        @guest
          <a href="{{ route('login.page') }}" class="btn paket-btn w-100 mb-3">6 x 60 Menit Rp 1.400.000</a>
          <a href="{{ route('login.page') }}" class="btn paket-btn w-100 mb-3">12 x 60 Menit Rp 1.680.000</a>

        @else
          @if(Auth::user()->nik == null)

            <a href="{{ route('data.lengkapi') }}" class="btn paket-btn w-100 mb-3">6 x 60 Menit Rp 1.400.000</a>
          ...
          @else
            ...
            <form action="{{ route('pilih.paket') }}" method="POST">
              @csrf
              <input type="hidden" name="nama_paket" value=" Kelas Dasar Matic">
              <input type="hidden" name="waktu" value="6 x 60 Menit">
              <input type="hidden" name="harga" value="1400000">
              <input type="hidden" name="jenis_paket" value="matic">
              <button class="btn paket-btn w-100 mb-3">6 x 60 Menit Rp 1.400.000</button>
            </form>
