...
<div class="container mt-5" style="max-width:700px;">
    ...
    <div class="calendar-wrapper">
        ...
        <!-- Judul dinamis berdasarkan jenis paket -->
        <h3 class="calendar-header text-center">
            Pilih Jadwal Kursus {{ strtoupper($jenis_paket) }}
        </h3>
        ...
        <form action="{{ route('jadwal.store') }}" method="POST" class="mt-3">
            ...
            <!-- Jenis paket otomatis dari controller -->
            <input type="hidden" name="jenis_paket" value="{{ $jenis_paket }}">
